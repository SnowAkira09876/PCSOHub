package com.ph.pcsolottowatcher.recyclerview.holder.allresults;
...
public class AllHistoryViewHolder extends RecyclerView.ViewHolder {
  private TextView tvDay, tvMonth, tvNumber, tvPrize, tvWinners, tvYear;
  private CircularDigitView circView;

  public AllHistoryViewHolder(AllHistoryItemBinding binding) {
